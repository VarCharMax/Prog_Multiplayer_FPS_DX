...
TargetPath=.\Release\Engine.lib
SOURCE="$(InputPath)"
PostBuild_Cmds=copy "$(TargetPath)" "..\..\Chapter 11\Engine\"	copy "$(TargetPath)" "..\..\Chapter 12\Engine\"	copy "$(TargetPath)" "..\..\Chapter 13\Engine\"
